    ...
    <>
      ...
      <section className="relative hidden min-h-[85vh] items-center justify-center overflow-hidden bg-[linear-gradient(103.43deg,#8a38f5_1.29%,#3d1273_39.23%,#040009_98.71%)] px-5 sm:px-8 md:flex md:px-12 lg:px-20">
        ...
        <div className="relative z-20 mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-4xl text-sm leading-7 text-gray-200 sm:text-base md:text-lg md:leading-8">
            We view marketing as a strategic growth engine—where creativity
            fuels engagement and data drives every decision. By blending market
            research, precision targeting, and compelling creative, we position
            your brand to capture attention, nurture interest, and convert
            prospects into lifelong customers. Whether launching a new product
            or scaling an established offering, our holistic campaigns deliver
            measurable uplift across every channel.
          </p>
        </div>
