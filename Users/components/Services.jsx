...
md:leading-8">
  ...
  <h2
    className="max-w-[1320px] mx-auto px-5 sm:px-8 lg:px-12 xl:px-20
    text-white italic
...
//         {/* <div className="relative z-10 mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12 xl:px-20 pt-28 md:pt-32 lg:pt-36 pb-20 md:pb-24 lg:pb-28"> */}
//         <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-14 sm:pb-20 md:pb-24 lg:pb-28">
//           {/* <div className="grid grid-cols-1 lg:grid-cols-[58%_42%] gap-14 lg:gap-12 items-center"> */}
...
//   {/* Purple Glow */}
//   <div className="absolute left-[-250px] top-[40%] h-[700px] w-[700px] rounded-full bg-[#7A00FF]/20 blur-[220px]" />

//   <div className="mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12 xl:px-20 relative z-10">
//     <h2
//       className="text-white italic text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-10 md:mb-12"
//       style={{ fontFamily: "serif" }}
//     >
//       Design & Development Process
//     </h2>
