...
//         text2: "Develop brand and digital strategy aligning with business objectives.",
...
//         text2: "Design high-fidelity mockups for website, app, or marketing collaterals.",
//         text3: "Focus on UI/UX best practices to ensure intuitive and engaging design.",
//         align: "left",
//         image: paintingBrush,
//     },
//     {
...
//         text2: "Resolve bugs, optimize performance, and ensure security compliance.",
...
//         text2: "Monitor performance and gather data for continuous improvement.",
...
// const ProcessCard = () => {
//     return (
//         <section className="relative bg-[#171717] py-32 overflow-hidden">
...
//                         {/* CARD WRAPPER */}
//                         <div
//                             className={`flex ${item.align === "left"
//                                 ? "justify-start"
//                                 : "justify-end"
//                                 }`}
//                         >
//                             <div className="w-[650px] rounded-2xl bg-[#242424] p-8 border border-white/10 hover:border-white/20 transition-all">
...
//                                 {/* POINTS */}
//                                 <ul className="list-disc pl-6 space-y-3 text-[#BDBDBD] text-[15px] leading-7">
//                                     <li>{item.text}</li>
//                                     <li>{item.text2}</li>
//                                     <li>{item.text3}</li>
//                                 </ul>
...
//                                 alt=""
//                                 className={`hidden lg:block absolute top-[155px] ${item.align === "left"
//                                         ? "left-[670px]"
//                                         : "left-[270px]"
//                                     }`}
//                             />
...
const ProcessCard = () => {
  return (
//     <section className="relative bg-[#171717] py-20 lg:py-28 overflow-hidden ">
...
//               }`}
//             >
//               <div className="w-full max-w-[650px] rounded-2xl bg-[#242424]
